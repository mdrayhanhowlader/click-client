        ...
        {posts.map((post) => (
          <div className="rounded-md shadow-md sm:w-96 dark:bg-gray-900 dark:text-gray-100">
            ...
            <p>
              ...
              voluptatibus numquam amet nisi quisquam nesciunt perferendis
              quibusdam quo consectetur sit, itaque cumque accusamus quis
              molestias nihil illo eos, tempore ut?
            </p>
